...
public:
	...
	void addIndividual(int indid, double onsetTime, int isCase, int age,int sex, int startFollowUp, int studyPeriod, int flha_titer_q, int stalk_titer_q, int na_titer_q, int haihk14_titer_q);
