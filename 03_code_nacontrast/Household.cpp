...
void Household::addIndividual(
  ...
  m_na_contrast.push_back(na_contrast);
...
double Household::log_pInf(
  ...
  int display
    ...
    if (m_na_contrast[ind] == 1 && selectedParam[6] ) beta_i *= parameter[6];
    if (m_na_contrast[ind] == 2 && selectedParam[7] ) beta_i *= parameter[7];
    ...
    if (m_na_contrast[curr] == 1 && selectedParam[4] ) beta *= parameter[4];  
    if (m_na_contrast[curr] == 2 && selectedParam[5] ) beta *= parameter[5];  
