...
param_names<-c("alpha", "beta", "delta", 
               "child", "sNA_contrast", "sNA_contrast2", "iNA_contrast", "iNA_contrast2")
...
namedatabase="mcmc_mcmc_results_nacontrast.txt"
...
save(parameterdistr, file='parameterdistr_initial_nacontrast.RData')
